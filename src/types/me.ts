...
export type MeResponse = {
  ...
  data: {
    ...
    social_synchronization: { facebook: { id: string; email: string } };
    traits: Trait[];
    ...
    location_preferences: { hide_location: boolean };
    ...
    biometric_preferences: { profile_verification: any };
    ...
    pending_likers: { counter_label: string; icon: any };
    login: string | null;
    device_info: number;
